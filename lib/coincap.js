...
/**
 * Sends and email to the address found in the config file to alert whether the task
 * completed or failed.
 * @param {string} status
...
/**
 * TODO
 * - Write tests for main server function
 * - Write mock tests for Mongodb
 * - Write tets for middleware functions.
 * - Heatmap for market share. 
